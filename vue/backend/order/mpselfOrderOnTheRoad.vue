<template>
	<div class="selfOrderOnTheRoadVue">
		<div class="shown">
			<div class="title">
			...
			<div class="content container result" v-for="o in selforderontheroad">
				<div class="row head">
					<div class="col-md-3">订单号:{{o.uniqueId}}</div>		
					<div class="col-md-3">下单时间:{{o.created_at}}</div>		
				</div>
				<div class="row data" v-for="m in selforderontheroad.orderProduct">
					...
					<div class="col-md-1 link" @click="toggle('detail',o.logisticsInfo,o.uniqueId,m.user,o.receiverName,o.receiverPhoneNumber,o.receiverAddress,o.orderProduct)">查看详情</div>		
				</div>
			</div>
		</div>
		<div class="hide">
			...
			<hr>
			<div class="operate">
 				<span class="sendGood myBtn" data-toggle="modal" data-target="model2">查看物流</span>
 				<div class="modal2 fade" tabindex="-1" role="dialog">
