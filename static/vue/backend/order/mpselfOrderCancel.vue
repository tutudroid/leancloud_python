<template>
	<div class="selfOrderCancelVue">
		<div class="shown">
			...
			<div class="content container result" v-for="o in selfordercancel">
				<div class="row head">
					<div class="col-md-3">订单号:{{o.uniqueId}}</div>		
					<div class="col-md-3">下单时间:{{o.created_at}}</div>		
				</div>
				<div class="row data" v-for="m in selfordercancel.orderProduct">
