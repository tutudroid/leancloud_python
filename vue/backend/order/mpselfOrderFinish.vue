<template>
	<div class="selfOrderFinishVue">
		<div class="shown">
			...
			<div class="content container result" v-for="o in selforderfinish">
				<div class="row head">
					<div class="col-md-3">订单号:{{o.uniqueId}}</div>		
					<div class="col-md-3">下单时间:{{o.created_at}}</div>		
				</div>
				<div class="row data" v-for="m in selforderfinish.orderProduct">
					...
					<div class="col-md-1 link" @click="toggle('detail',o.logisticsInfo,o.productComment,m.user,o.receiverName,o.receiverPhoneNumber,o.receiverAddress,o.orderProduct)">查看详情</div>		
				</div>
			</div>
		</div>
		<div class="hide">
			...
			<hr>
			<div class="operate">
				<span class="sendGood myBtn" data-toggle="modal" data-target="modal4">查看物流</span>
				<div class="modal4 fade" tabindex="-1" role="dialog">
				...
				<span class="sendGood myBtn" data-toggle="modal" data-target="modal5">查看评价</span>
				<div class="modal5 fade" tabindex="-1" role="dialog">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script>
	export default{
		...
		props:["selforderfinish"],
		methods:{
			toggle(detail="",logi,productComment,user,receiverName,receiverPhoneNumber,receiverAddress,orderProduct){
				if(detail == "detail"){
					this.logistic = logi;
