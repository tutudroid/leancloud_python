...
def set_image(name, imageFile, attribute):
    """
    :param attribute: 
    :param name: 类的实例 
    :param imageFile: 从file中上传的文件名
    :return: 
    """
    if name is None or imageFile is None or attribute is None:
        sys_log('parameter is null')
        return False
    tup = tempfile.mkstemp()
    file = open(tup[0], 'wb+')
    for chunk in imageFile.chunks():
        file.write(bytes(chunk, encoding="utf8"))
    lc_file = leancloud.File(imageFile.name, data=file)
    name.set(attribute, lc_file)
    if save_data(name):
        return True
    else:
        return False
...
def get_relation_data(objectId, className, relation_value, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param limit: 
    :param skip: 
...
def get_relation_data_and_exist(objectId, className, relation_value, attribute, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param attribute: 
    :param limit: 
...
def get_relation_data_and_attribute_and_sort_uniqueId(objectId, className, relation_value, attribute, value, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param limit: 
    :param skip: 
...
def get_relation_data_greater_attribute(objectId, className, relation_value, attribute, value, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param limit: 
    :param skip: 
...
def query_relation_data_greater_and_less_attribute(objectId, className, queryClassName, attribute, value, value2, method=None, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param method: 
    :param limit: 
...
def get_relation_data_greater_and_less_attribute(objectId, className, queryClassName, attribute, value, value2, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param limit: 
    :param skip: 
...
def get_relation_data_and_attribute_two(objectId, className, relation_value, attribute, value1, value2, skip=None, limit=None):
    """
    获得关联表的所有数据
    :param limit: 
    :param skip: 
...
def queryExistInstance(className, attribute, skip=None, limit=None):
    """
    通过name获得类的实例信息
    :expand: 如果expand为空，则返回基本信息，否则，返回point指向对象的所有信息，此时，可以使用get方法获得数据。
    :return: 
...
def queryInstanceAttributeGreaterOrEqual(className, attribute, value, skip=None, limit=None):
    """
    通过name获得类的实例信息
    :expand: 如果expand为空，则返回基本信息，否则，返回point指向对象的所有信息，此时，可以使用get方法获得数据。
    :return: 
...
def queryInstanceAttribute_and_sort_uniqueId(className, attribute, value, skip=None, limit=None):
    """
    通过name获得类的实例信息
    :expand: 如果expand为空，则返回基本信息，否则，返回point指向对象的所有信息，此时，可以使用get方法获得数据。
    :return: 
...
def queryInstanceAttribute1_Attribute2(className, attribute, value, attribute2, value2, skip=None, limit=None):
    """
    通过name获得类的实例信息
    :expand: 如果expand为空，则返回基本信息，否则，返回point指向对象的所有信息，此时，可以使用get方法获得数据。
    :return: 
...
def queryAllInstance(className, element, skip=None, limit=None):
...
def paginator_private(page, num_pages, count):
    ...
    if page and page - has_previous >= 0:
